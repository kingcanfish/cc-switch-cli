...
[![Version](https://img.shields.io/badge/version-0.0.5-blue.svg)](https://github.com/kingcanfish/cc-switch-cli/releases)
...
curl -LO https://github.com/kingcanfish/cc-switch-cli/releases/latest/download/cc-switch-cli-v0.0.5-darwin-universal.tar.gz

# Extract
tar -xzf cc-switch-cli-v0.0.5-darwin-universal.tar.gz
...
```bash
# Download
curl -LO https://github.com/kingcanfish/cc-switch-cli/releases/latest/download/cc-switch-cli-v0.0.5-linux-x64-musl.tar.gz

# Extract
tar -xzf cc-switch-cli-v0.0.5-linux-x64-musl.tar.gz
...
curl -LO https://github.com/kingcanfish/cc-switch-cli/releases/latest/download/cc-switch-cli-v0.0.5-linux-arm64-musl.tar.gz
tar -xzf cc-switch-cli-v0.0.5-linux-arm64-musl.tar.gz
chmod +x cc-switch-cli
sudo mv cc-switch-cli /usr/local/bin/
```
...
# https://github.com/kingcanfish/cc-switch-cli/releases/latest/download/cc-switch-cli-v0.0.5-windows-x64.zip
